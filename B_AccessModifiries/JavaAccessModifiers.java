...
public class JavaAccessModifiers {
    public static void main(String[] args) {
        /*
            ...
            Access Modifiers in Java control the visibility and accessibility of classes, methods, and variables in
            different parts of a program. They help in data hiding, encapsulation, and security.

            1. What are Access Modifiers?
            Access Modifiers in Java are keywords that define the scope of a class, method, or variable.
            They determine who can access them.
